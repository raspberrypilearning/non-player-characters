...
Start de Unity Hub en open het project dat je hebt gemaakt voor [Sterren Verzamelaar ](https://projects.raspberrypi.org/nl-NL/projects/star-collector/0){:target='_blank'}.
...
[rpf.io/p/nl-NL/non-player-characters-go](https://rpf.io/p/nl-NL/non-player-characters-go)
...
--- task ---
Selecteer het Gamemaster's **Canvas** en schakel het uit door het vakje in de Inspector uit te vinken.
